...
urlpatterns = [
    ...
    path("product/<int:product_number>/update-wishlist", update_wishlist, name="update-wishlist"),
    ...
    path("countries/<str:name>/", CountryProductsListView.as_view(), name="country-products-list"),
